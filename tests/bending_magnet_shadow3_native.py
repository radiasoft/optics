...
def run_bending_magnet_shadow3_native(example_index):
...
def test_bending_magnet_infrared_shadow3_native():
    shadow_beam = run_bending_magnet_shadow3_native(0)
    # Do some tests.
...
def test_bending_magnet_xrays_shadow3_native():
    shadow_beam = run_bending_magnet_shadow3_native(1)
    # Do some tests.
    # Shadow results are random. But test at least that it really run.
...
if __name__ == "__main__":
    ...
    shadow_beam = test_bending_magnet_infrared_shadow3_native()
    Shadow.ShadowTools.plotxy(shadow_beam,1,3,nbins=101,title="Real space for infrared example")

    shadow_beam = test_bending_magnet_xrays_shadow3_native()
    Shadow.ShadowTools.plotxy(shadow_beam,1,3,nbins=101,title="Real space for xrays example")
